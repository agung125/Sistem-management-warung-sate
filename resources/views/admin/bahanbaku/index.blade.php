<x-app-layout>
                                ...
                                @foreach ($bahans as $bahan)
                                    <tr
                                        ...
                                        <th scope="row"
                                            ...
                                            <img class="w-10 text-center h-10 rounded-full" src="{{ asset('img/bahan.png') }}"
                                                alt="Jese image">
                                            <div class="ps-3">
                                                <div class="text-base text-center font-semibold">{{ $bahan->nama }}</div>
    ...
    <div id="crud-modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 w-full max-w-2xl md:max-w-4xl h-auto">
            <!-- Modal content -->
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <!-- Modal body -->
                <form class="p-4 md:p-5" action="{{ route('admin.bahanbaku.store') }}" method="POST">
                    @csrf
                    <div class="grid gap-4 mb-4 grid-cols-1 sm:grid-cols-2">
                        <div class="col-span-2">
                            ...
                            <input type="text" name="nama" id="name"
                                ...
                                placeholder="Inputkan nama bahan" required="">
                        </div>
                        <div class="col-span-1">
                            ...
                            <input type="number" name="qty" id="qty" min="0"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Inputkan harga bahan" required="">
                        </div>
                        <div class="col-span-1">
                            <label for="harga"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Harga</label>
                            <input type="number" name="harga_persatuan" id="harga_persatuan" min="0"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Inputkan harga bahan" required="">
                        </div>
                        <div class="col-span-1">
                        ...
                        <div class="col-span-2">
                            ...
                            <input type="date" name="tanggal_kadaluarsa" id="tanggal_kadaluarsa"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Inputkan tanggal kadaluarsa bahan" required="">
    ...
    <script>
        // JavaScript code to initialize and toggle the modal
